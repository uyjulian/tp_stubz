...
CFLAGS += -D_USRDLL -DMINGW_HAS_SECURE_API -DUNICODE -D_UNICODE -DSTRICT
...
ifneq (x$(wildcard third_party_cmake/CMakeLists.txt),x)
...
$(SOURCES): $(DEPENDENCY_BUILD_DIRECTORY_THIRD_PARTY_CMAKE)/build-libraries/include/third_party_cmake.h
